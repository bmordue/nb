class DbConnector:
    ...
    def add_comment_count(self, comments_url, count): raise NotImplementedError

    def add_story(self, nb_hash, added, comments_url, story_url): raise NotImplementedError

    def close_connection(self): raise NotImplementedError

    def ensure_domains_table_exists(self): raise NotImplementedError
    ...
    def list_stories_without_comment_count(self): raise NotImplementedError
